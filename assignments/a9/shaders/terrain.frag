...
vec3 shading_terrain(vec3 pos) {
	...
	vec3 emissiveColor;
	if (h >= 0) {
		emissiveColor = mix(vec3(243. / 255, 246. / 255, 251. / 255), vec3(255. / 255, 255. / 255, 255. / 255), h);
	}
	else {
		emissiveColor = mix(vec3(243. / 255, 246. / 255, 251. / 255), vec3(209. / 255, 233. / 255, 255. / 255), h);
	}
